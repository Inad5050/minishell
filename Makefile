...
#    Updated: 2024/11/02 23:50:42 by dangonz3         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
/parser/check_commands.c /parser/delete_quotes.c /parser/envp_aux.c /parser/expand_vars.c /parser/getprompt.c /parser/here_doc.c /parser/init_struct.c /parser/lexer.c /parser/open_files.c /parser/others.c /parser/parser.c /parser/pipex.c /parser/t_commands_fill.c /parser/t_commands.c /parser/token_check.c\
